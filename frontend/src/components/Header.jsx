          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="hidden md:block w-10 h-10 rounded-full bg-secondary border-2 border-foreground flex items-center justify-center hover:animate-wiggle shadow-hard-sm transition-all focus:outline-none focus:ring-2 focus:ring-ring"
              >
